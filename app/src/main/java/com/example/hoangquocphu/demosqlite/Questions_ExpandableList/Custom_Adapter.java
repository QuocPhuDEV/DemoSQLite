...
public class Custom_Adapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int listPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.group_item_question, null);
        }
        TextView listTitleTextView = (TextView) convertView
                .findViewById(R.id.tvQuestionEx);
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = layoutInflater.inflate(R.layout.item_answer_yesno, null);
        }
