...
public class Question_List_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question__list_);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == MENU_ITEM_VIEW) {
            ...
            Intent intent = new Intent(this, Cus_Activity.class);
